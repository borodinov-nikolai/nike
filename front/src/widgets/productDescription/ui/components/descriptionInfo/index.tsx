    ...
    <div className={styles.root} >
      ...
      <div className={styles.colors} >
        ...
        <ul className={styles.colorsList} >
          {colors?.map(({ id, value }) => <li key={id} className={styles.color} style={{ background: value }} ></li>)}
        </ul>
      </div>
      ...
      <div className={styles.sizes} >
        ...
        <ul className={styles.sizesList} >
           {allSizes.map((size, i)=> availableSizes.includes(size) ? <li className={styles.size} key={size} >{size}</li>: <li className={[styles.size, styles.size__disabled].join(' ')} key={size} >{size}</li> )}
        </ul>
      </div>
    </div>
  )
